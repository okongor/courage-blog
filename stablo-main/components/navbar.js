    ...
    <Container>
      <nav>
        <Disclosure>
          {({ open }) => (
            <>
              <div className="flex flex-wrap w-full justify-between md:flex-nowrap md:gap-10">
                
                <div className="flex w-full items-center justify-between md:w-auto">
                  <Link href="/" className="w-38 dark:hidden">
                    {props.logo ? (
                      <Image
                  ...
                  <Link href="/" className="hidden w-38 dark:block">
                    {props.logoalt ? (
                      <Image
